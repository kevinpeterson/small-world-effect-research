...
Popular projects do appear to conform to the results found by Uzzi\cite{uzzi2005collaboration}. As show in figure \ref{fig:cc_popular}, $Q$ near the extremes show a relatively low likelihood of being popular. As $Q$ values approach mid-range values, the probability of a project being a success increases greatly.
...
\end{center}
\caption{$Q$ of Popular Projects}
\label{fig:cc_popular}
\end{figure}

The inverse is true of unpopular projects. As $Q$ near the extremes, a high probability of being unsuccessful is observed. Mid-valued $Q$ values indicate a substantially lower probability of being unsuccessful.

\begin{figure}
\begin{center}
\includegraphics[width=0.5\textwidth]{images/freecode-unpopular.png}
\end{center}
\caption{$Q$ of Unpopular Projects}
\label{fig:cc_unpopular}
\end{figure}

Distribution of $Q$ values are shown in figure\ref{fig:q_distribution}. The values of $Q$ generally follow a power-law distribution, with most values being at our around $Q = 1$. This indicates that many graphs are close to the delineation of being considered small-world\cite{humphries2008network}.
