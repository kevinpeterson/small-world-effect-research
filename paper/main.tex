...
The research interviews provided a look into how some of these quantitative findings translate into actual industry practice. There were are few re-occurring themes that we will base our analysis on\cite{stmartin_interview,stmartin_interview}:
...
\noindent\\\textit{\textbf{Priority and timeline are strong drivers.}}\\
